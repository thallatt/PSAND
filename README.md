...
The structure grids cover equilibrium temperatures [288,2884] K, core masses {10,20} Earth masses, and total masses [10.1,300] Earth masses. We are currently improving the high metallicity atmosphere models, so we only include solar composition models in the current version of PSAND.
